(define (problem hanoi-10)
  ...
  (:init 
    ...
    (smaller d6 p1)(smaller d6 p2)(smaller d6 p3)
    (smaller d7 p1)(smaller d7 p2)(smaller d7 p3)
    (smaller d8 p1)(smaller d8 p2)(smaller d8 p3)
    (smaller d9 p1)(smaller d9 p2)(smaller d9 p3)
    (smaller d10 p1)(smaller d10 p2)(smaller d10 p3)
  ...
  (:goal 
    (and (on d1 d2)(on d2 d3)(on d3 d4)(on d4 d5)(on d5 d6)(on d6 d7)(on d7 d8)(on d8 d9)(on d9 d10)(on d10 p1) )
  )
)
